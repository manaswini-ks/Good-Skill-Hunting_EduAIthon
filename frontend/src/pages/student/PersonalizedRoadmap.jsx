      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ color: '#5D6D7E', margin: '8px 0 0', fontSize: 14 }}>
              Get a tailored learning path for your software engineering journey
            </p>
          </div>
          <Link
            to="/questions"
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            <textarea
              ...
              placeholder="Describe your current skill level, goals, and preferences for your learning path..."
              style={{ 
                width: '100%', 
        ...
        {loading && (
          ...
          >
            ...
            ></div>
            <p style={{ color: '#3498DB', margin: 0, fontWeight: 500 }}>Generating your roadmap...</p>
            <style>{`
irono
              @keyframes spin {
        ...
        {history.length > 0 && (
          ...
          >
            ...
            >
              <span>Previous Roadmaps ({history.length})</span>
              <button
                onClick={() => setHistory([])}
                style={{
                  background: 'none',
